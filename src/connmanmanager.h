 ...
 * Command line was: qdbusxml2cpp -c ConnmanManager -p connmanmanager.h:connmanmanager.cpp connman-manager.xml
 *
...
#ifndef CONNMANMANAGER_H_1350291482
#define CONNMANMANAGER_H_1350291482
...
namespace net {
  namespace connman {
    typedef ::ConnmanManager Manager;
  }
}
#endif
